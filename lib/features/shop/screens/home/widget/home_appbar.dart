...
import '../../../../../common/widgets/prodacts/cart/cart_menu_icon.dart';
import '../../../../../utills/constants/colores.dart';
import '../../../../../utills/constants/text_strings.dart';
class THomeAppBare extends StatelessWidget {
  const THomeAppBare({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return TAppBar(
      ...
      actions:  [
        TCartCountIcon(onPressed: ()=>Get.to(()=>const CartScreen()),iconColor: TColore.white,)
      ],
    );
  }
}